...
(initial implementation written for JDMS special issue paper - Aug 2016).
*)



BeginPackage["FCMLib`"]
$FCMLibVersion = "Fuzzy Cognitive Map Library ver. 0.0.7+";
...
Sow@Table[
{e,ws[[k]]*PropertyValue[{fcms[[k]], e}, EdgeWeight]},{e, EdgeList@fcms[[k]]}],
{k,Length@fcms}
];
